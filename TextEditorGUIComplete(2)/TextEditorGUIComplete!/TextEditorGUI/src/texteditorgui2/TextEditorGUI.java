...
public class TextEditorGUI extends javax.swing.JFrame implements ActionListener, DocumentListener, WindowListener, UndoableEditListener {
    ...
    public TextEditorGUI() {
        initComponents();
        txtDoc.getDocument().addUndoableEditListener(this);
    ...
    private void initComponents() {
        ...
        btnUndo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texteditorgui2/Undo24.gif"))); // NOI18N
        ...
        btnFind.setIcon(new javax.swing.ImageIcon(getClass().getResource("/texteditorgui2/Find16.gif"))); // NOI18N
        ...
        layeredPanel.setLayer(btnUndo, javax.swing.JLayeredPane.DEFAULT_LAYER);
        layeredPanel.setLayer(btnFind, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        layeredPanelLayout.setHorizontalGroup(
            ...
            .addGroup(layeredPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnUndo, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layeredPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layeredPanelLayout.createSequentialGroup()
                        .addGroup(layeredPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnUndo, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap())))
        );
        ...
        topPanelLayout.setHorizontalGroup(
            ...
            .addComponent(layeredPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 955, Short.MAX_VALUE)
        ...
        lowPanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, lowPanelLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(statusLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 752, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(wordLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void txtDocCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_txtDocCaretUpdate
        try {
            int caretPosition = txtDoc.getCaretPosition();
            int lineNumber = txtDoc.getLineOfOffset(caretPosition) + 1;
            int columnNumber = caretPosition - txtDoc.getLineStartOffset(lineNumber - 1) + 1;

            wordLabel.setText("Line: " + lineNumber + " Column: " + columnNumber);
    ...
    public void newFile() {
        ...
        dirty = false;
        if (newValue == 0) {
            curFile = new File("filename.txt");
            try {
                if (curFile.createNewFile()) {
                    System.out.println("File created: " + curFile.getName());
                } else {
    ...
    public void saveFile() {
        ...
        if (retValue == 0) {
            try {
                ...
                if (!curFile.getName().toLowerCase().endsWith(".txt")) {
                    curFile = new File(curFile.getAbsolutePath() + ".txt");
                }
                ...
                reader.close();
                writer.close();
                statusLabel.setText("File Saved on:  " + curFile.getAbsolutePath());
                nameLabel.setText(curFile.getName());
    ...
    public void upload() {
        ...
        if (chooserValue == JFileChooser.APPROVE_OPTION) {
            try {
                curFile = chooser.getSelectedFile();
                Scanner fin = new Scanner(curFile);
                String buffer = "";
                while (fin.hasNext()) {
                    buffer += fin.nextLine() + "\n";
                }
                ...
                fin.close();
                statusLabel.setText("Loaded: " + curFile.getAbsolutePath());
                nameLabel.setText(curFile.getName());
    ...
    public void Undo() {
        if (undoManager.canUndo()) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "An error occured. Unable to undo. \n" + e.getLocalizedMessage());
            }
        }
    }
    ...
    public void Redo() {
        if (undoManager.canRedo()) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "An error occured. Unable to redo. \n" + e.getLocalizedMessage());
            }
        }
    }
